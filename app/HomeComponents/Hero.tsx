...
export default function Hero() {
    ...
    return (
    <div className="">
        <div className="hero-container lg:mx-[80px] py-[60px] lg:py-[100px] lg:mt-[20px]">
            <div className="text-white px-5 flex flex-col items-start lg:ml-6">
                
                <div className="flex flex-col mt-4  mb-[40px] ">
                    <h1 ref={headingRef} className="text-2xl text-left  font-semibold   leading-normal text-white">
