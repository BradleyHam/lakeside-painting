...
function Projects({ projects }: { projects: Project[] }) {
  ...
  return (
    <div className='mb-28'>
      <div className='flex flex-col space-y-6 lg:space-y-0 lg:flex-row lg:items-start bg-light-bg py-[60px] px-5 lg:px-[80px]'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-[40px] mx-5 lg:mx-[60px]">
