...
export default function ProjectCard({ title, largeImage, categories, topHeavy, slug, tags, shortDesc }: ProjectCardProps) {
  return (
    <div className="group h-full shadow-[0_20px_25px_-5px_rgba(0,0,0,0.08),0_10px_10px_-5px_rgba(0,0,0,0.08)] relative">
      ...
      <div className="card-content px-4 py-8 flex flex-col items-start bg-white text-primary space-y-4 lg:space-y-3 relative z-0">
